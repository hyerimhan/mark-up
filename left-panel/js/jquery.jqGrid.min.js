...
150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",P===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(P=a.inArray(P,ga),-1!==P&&(d.p.colModel[k].lso=ba[P])),M+=ea+"</div></th>";M+="</tr></thead>";ea=null;a(this).append(M);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover1")},function(){a(this).removeClass("ui-state-hover1")});if(this.p.multiselect){var ia=[],$;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=
